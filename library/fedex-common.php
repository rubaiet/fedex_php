...
function getProperty($var){
	if($var == 'key') Return 'US61hPf8PRDk5k1R'; 
	if($var == 'password') Return 'RRb9BD80L7uoqueWqNnQGniTw'; 
	if($var == 'shipaccount') Return '510087461';
	if($var == 'billaccount') Return '510087461'; 
	if($var == 'dutyaccount') Return '510087461'; 
	if($var == 'freightaccount') Return '510087461';  
	if($var == 'trackaccount') Return '510087461'; 
	if($var == 'dutiesaccount') Return '510087461';
	if($var == 'importeraccount') Return '510087461';
	if($var == 'brokeraccount') Return '510087461';
	if($var == 'distributionaccount') Return '510087461';
